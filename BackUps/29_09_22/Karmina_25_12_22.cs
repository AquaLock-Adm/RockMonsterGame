...
public class Karmina : Weapon
{
    ...
    public override List<Action> GetCompleteMoveList(){
        ...
        Actions_l.Add(new Combustion(new Element(SpellElement.none), new Element(SpellElement.none)));
        Actions_l.Add(new Stomp());
        Actions_l.Add(new AxeThrow(new Element(SpellElement.none)));
        Actions_l.Add(new ManaSurge());
        Actions_l.Add(new BrainDeath());
        Actions_l.Add(new BarbariansRaid(new Element(SpellElement.none)));
        Actions_l.Add(new KaminasDivider(new Element(SpellElement.none)));
    ...
    public override Action CombineActions(string comboList, List<Action> Actions_l){
        ...
        switch(comboList){
            ...
            case "EE":
                res = new Combustion(Actions_l[0], Actions_l[1]);
            break;
            ...
            case "EHSS":
                res = new BarbariansRaid(Actions_l[0]);
            break;

            case "HHESS":
                res = new KaminasDivider(Actions_l[2]);
            break;
    ...
    {
        public Combustion(Action E1, Action E2){
            this.SetGameHandler();
            this.Player = this.GameHandler.Player;
        ...
        public override Action Copy(){
            Action A =  new Combustion(this.Elements[0], this.Elements[1]);
            A.abilityIndex = this.abilityIndex;
            return A;
        }
    }
    ...
    private class AxeThrow : Action
    {
        ...
        public override Action Copy(){
            Action A =  new AxeThrow(this.Elements[0]);
            A.abilityIndex = this.abilityIndex;
            return A;
        }
    }
    ...
    {
        public BarbariansRaid(Action E){
            this.SetGameHandler();
            this.Player = this.GameHandler.Player;
            ...
            this.element = E.element;
            this.Elements.Add(E);
            this.damage = E.maxBaseDamage;
            this.maxBaseDamage = E.maxBaseDamage;
            this.apCost = E.apCost;
            this.manaCost = E.manaCost;
        ...
        public override Action Copy(){
            Action A =  new BarbariansRaid(this.Elements[0]);
            A.abilityIndex = this.abilityIndex;
            return A;
        }
    ...
    {
        public KaminasDivider(Action E){
            this.SetGameHandler();
            this.Player = this.GameHandler.Player;
        ...
        public override Action Copy(){
            Action A = new KaminasDivider(this.Elements[0]);
            A.abilityIndex = this.abilityIndex;
            return A;
        }
        ...
        private class KaminasDivider_E : UniqueEffect
        {
            ...
            public override async Task<int> ActivateUniqueEffect(){ // gets called instead of normal execute functions // TODO!
                ...
                this.Action.PrintAction();
                await this.Action.Player.DepleteMana(-this.Action.manaGain);
                
                this.Action.Player.actionPointGain += this.Action.apCost + this.Action.apGain;
