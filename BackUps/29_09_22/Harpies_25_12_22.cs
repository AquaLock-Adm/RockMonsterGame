...
public class Harpies : Weapon
{
    ...
    public override List<Action> GetCompleteMoveList(){
        ...
        Actions_l.Add(new Sprint(new Element(SpellElement.none)));
        Actions_l.Add(new SoulStealer(new Element(SpellElement.none), new Element(SpellElement.none)));
        Actions_l.Add(new HeartPiercer());
        Actions_l.Add(new HarpiesLifeEnder(new Element(SpellElement.none), new Element(SpellElement.none), new Element(SpellElement.none)));
    ...
    public override Action CombineActions(string comboList, List<Action> Actions_l){
        ...
        switch(comboList){
            ...
            case "LEL":
                res = new Sprint(Actions_l[1]);
            break;

            case "EELS":
                res = new SoulStealer(Actions_l[0], Actions_l[1]);
            break;
            ...
            case "LEEEL":
                res = new HarpiesLifeEnder(Actions_l[1], Actions_l[2], Actions_l[3]);
            break;
    ...
    private class Sprint : Action
    {
        ...
        public override Action Copy(){
            Action A =  new Sprint(this.Elements[0]);
            A.abilityIndex = this.abilityIndex;
            return A;
        }
    }
    ...
    {
        public SoulStealer(Action E1, Action E2){
            this.SetGameHandler();
            this.Player = this.GameHandler.Player;
        ...
        public override Action Copy(){
            Action A =  new SoulStealer(this.Elements[0],this.Elements[0]);
            A.abilityIndex = this.abilityIndex;
            return A;
        }
    ...
    {
        public HarpiesLifeEnder(Action E1, Action E2, Action E3){
            this.SetGameHandler();
            this.Player = this.GameHandler.Player;
        ...
        public override Action Copy(){
            Action A =  new HarpiesLifeEnder(this.Elements[0],this.Elements[1],this.Elements[2]);
            A.abilityIndex = this.abilityIndex;
            return A;
        }
