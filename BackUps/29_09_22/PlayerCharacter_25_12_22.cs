...
public class PlayerCharacter : Unit
{
    ...
    public int spentActionPoints = 0;

    public int startActionPoints;
    public int roundStartActionPointGain;
    ...
    public virtual void UpdateHUDElements(){
        // this.ApText.text = "AP: "+this.currentActionPoints.ToString()+" ("+(this.spentActionPoints*-1).ToString()+")";
        // this.MenuApText.text = (this.currentActionPoints - this.spentActionPoints).ToString();
    ...
    public virtual void SetupHUDElements() {
        ...
        // this.ApText = this.BattleSystem.PlayerApText;
        // this.MenuApText = this.BattleSystem.MenuApText;
        this.ManaSlider = this.BattleSystem.PlayerManaSlider;
    }

    public void ResetActionPointGain(){

        this.actionPointGain = 0;
    }

    public override async Task MissedAttack(){
    ...
    public async Task DepleteMana(int amount){
        if(amount == 0) return;
