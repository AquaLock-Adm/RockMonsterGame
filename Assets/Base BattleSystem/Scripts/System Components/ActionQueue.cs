...
// 	/*private*/public bool stopQueue = false;

// 	private float standartActionBoxHeight = 58f;
// 	private float standartActionBoxWidth = 100f;

// 	[Header("Combo Heat Settings")]
// 	[SerializeField] private int[] heatLimits = {0,1,2,8,12,20,50,112,225,0};

	
// 	[Header("System Counters")]
// 	private int currentMaxAttackLength;
...
// 	private List<string> AvailableComboActionsAsStrings = new List<string>(); // idk, need another var name, this one sucks

// 	[Header("UI References")]
//     [SerializeField] private GameObject ActionBoxPrefab;
// 	[SerializeField] private Text ComboLevelText;
...
// 		this.maxComboLv = this.comboLevel;
...
// 	public void SetComboLevel(){
// 		this.maxComboLv = BattleSystem.Player.GetWeapon().actionsPerRound;
...
// 	public void SwitchModes(bool playerDefending){
// 		if(playerDefending){
// 			this.currentMaxAttackLength = this.comboLevel;
// 			int comboLengthMax = BattleSystem.Enemy.GetCurrentAttackSequenceLength();
...
// 		if(BattleSystem.defendModeActive){
...
// 		while(executedActions < TargetEnemy.GetCurrentAttackSequenceLength() && !stopQueue) {
// 			Action CurrentAction = new NoBlock(BattleSystem.Player);
...
// 		BattleSystem.Player.LoadMainMenu();
// 	}
...
// 		UpdateVisualizer();
// 		PlayerCharacter Player = BattleSystem.Player;
...
// 		BattleSystem.Player.EnableAttackRushInputs(false);
